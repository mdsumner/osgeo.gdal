...
Can turn on the reprojection, can turn on simplification (try reading just one at a time, it's about 200Mb of geometry total over a url for the default data source, or set your own). 


`ia` means index of arbitrary positions, so you're assumed to know how many are there atm - use og_read_fields() to get the fields first. 
